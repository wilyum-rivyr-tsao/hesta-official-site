...
function Index() {
  ...
  return (
    <>
      ...
      <div className="bg-[url('/imgs/customer_user/bg_second.png')] bg-cover bg-center bg-no-repeat">
        <div className="mx-auto flex min-h-[900px] max-w-[1160px] justify-between py-[176px]">
          ...
          <div className="grid max-h-[600px] min-w-[576px] grid-cols-2 gap-4">
            <div className="h-[263px] w-[280px] rounded-md border border-[#fff] bg-[#f7f8fb] px-[40px] py-[30px]">
              <Image
                src={'/imgs/customer_user/icon_platform1.png'}
                width={70}
                height={70}
                alt={''}
              />
      ...
      <div className="mx-[10px] my-[100px] flex min-h-[900px] flex-col items-center">
        ...
        <div className="flex">
          <div className={`mt-14 flex ${advatage !== 1 && 'hidden'}`}>
            <div className="advantage z-20 -ml-4 -mt-10 h-[470px] w-[484px] justify-center border border-[#383B43] bg-[#E9ECF4] bg-cover bg-center bg-no-repeat px-10 py-16 hover:border-0 hover:bg-[url('/imgs/3dicon_platform1.png')]">
            ...
            <div className="advantage z-20 -ml-4 mt-10 h-[470px] w-[484px] justify-center border border-[#383B43] bg-[#E9ECF4] bg-cover bg-center bg-no-repeat px-10 py-16 hover:border-0 hover:bg-[url('/imgs/customer_user/3dicon_intelligence1.png')]">
              <p className="font-harmony font-light">
            ...
            <div className="advantage -ml-4 mt-20 h-[470px] w-[484px] justify-center border border-[#383B43] bg-[#E9ECF4] bg-cover bg-center bg-no-repeat px-10 py-16 hover:border-0 hover:bg-[url('/imgs/3dicon_interaction1.png')]">
              <p className="font-harmony font-light">
          ...
          <div className={`mt-14 flex ${advatage !== 2 && 'hidden'}`}>
            <div className="advantage z-20 -ml-4 -mt-10 h-[470px] w-[484px] justify-center border border-[#383B43] bg-[#E9ECF4] bg-cover bg-center bg-no-repeat px-10 py-16 hover:border-0 hover:bg-[url('/imgs/3dicon_customization1.png')]">
              <p className="font-harmony font-light">
                HESTA
            ...
            <div className="advantage z-20 -ml-4 mt-10 h-[470px] w-[484px] justify-center border border-[#383B43] bg-[#E9ECF4] bg-cover bg-center bg-no-repeat px-10 py-16 hover:border-0 hover:bg-[url('/imgs/3dicon_life1.png')]">
              <p className="font-harmony font-light">
