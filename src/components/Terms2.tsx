...
function Terms() {
  ...
  const close = () => {
    dispatch({ type: 'showTerms2', payload: false });
  };
  return (
    <SlideUpModal close={close}>
      <div>
        <h1 className="mb-[69px] flex font-harmony text-[40px] font-black">悉瞰公司网页用户协议</h1>
        <div className="h-[40vh] overflow-y-auto font-harmony">
          <p>
